...
var serialPort = new SP.SerialPort('/dev/ttyUSB1', {
    baudrate: 115200,
        ...
        serialPort.on('data', function(rawData){
            ...
            if(data[0] == '#r'){
                ...
                var packet = {
                    ...
                    msg: {
                        id: parseInt(msg[0]),
                        timefix: parseInt(msg[1]),//moment.unix(parseInt(msg[1])),
                        latitude: parseInt(msg[2].substr(1, 2))+(parseFloat(msg[2].substr(3))/60),
                        longitude: -parseInt(msg[3].substr(1, 2))-(parseFloat(msg[3].substr(3))/60),
